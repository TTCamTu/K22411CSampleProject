...
public class SendSMSActivity extends AppCompatActivity {
    ...
    private void addEvents() {
        ...
        img_sms2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    private void addViews() {
        ...
        img_sms1=findViewById(R.id.img_sms1);
        img_sms2=findViewById(R.id.img_sms2);
        ...
        if(ti!=null)
        {
            ...
            txtPhoneNumber.setText(ti.getPhone());
        }
    }
